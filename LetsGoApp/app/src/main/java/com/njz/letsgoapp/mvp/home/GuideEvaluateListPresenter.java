...
public class GuideEvaluateListPresenter implements GuideEvaluateListContract.Presenter {
    ...
    @Override
    public void orderReviewsFindGuideReviews(int guideId,int serveId, String value, int limit, int page) {
        ...
        MethodApi.orderReviewsFindGuideReviews(guideId,serveId,value, limit, page, new OnSuccessAndFaultSub(listener,context,false));
    }
}
