...
public class GuideScoreView2 extends LinearLayout {

    TextView guideScoreService, guideScoreLine, guideScoreScore, guideScoreComment;


    public GuideScoreView2(Context context) {
        this(context, null);
    }

    public GuideScoreView2(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public GuideScoreView2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        View view = LayoutInflater.from(context).inflate(R.layout.view_guide_score2, this, true);
    ...
    public void setGuideScoreService(int service) {
        guideScoreService.setText("已售" + service);
    }

    public void setGuideScoreScore(float score) {
        StringUtils.setHtml(guideScoreScore,String.format(getResources().getString(R.string.service_score),score+""));
    }
